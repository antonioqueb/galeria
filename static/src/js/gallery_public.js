...
// Formato único del sistema: "13 ago 2026". Arreglo manual de meses porque
// toLocaleDateString('es-MX') devuelve "sept" (4 letras) y no respeta el
// formato. Parsea la cadena SIN construir Date: new Date("2026-08-13") se
...
class GalleryApp {
    ...
    async confirmReservation() {
        ...
        const expiryStr = somFormatDate(expiryDate);
